...
public class CalcIntegral {  //метод левых прямоугольников
        ...
        public static double integrate(DoubleUnaryOperator f, double a, double b) {
            ...
            double step = 1e-6; // Шаг не больше 10^(-6)
            double sum = 0.0;
 ...
 * a и b, причем a<=b. Для получения достаточно точного результата используйте шаг сетки не больше 10( в −6 степени).
 *
 * Пример. Вызов
 *
 * integrate(x -> 1, 0, 10)
