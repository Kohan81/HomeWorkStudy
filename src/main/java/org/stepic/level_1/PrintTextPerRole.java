...
public class PrintTextPerRole {
    public static void main(String[] args) {
        ...
        PrintTextPerRole printer = new PrintTextPerRole();
        System.out.println(printer.printTextPerRole(roles, textLines));
...
//            for (int j = 0; j < textLines.length; j++) {
//
//                if (role.equals(textLines[j].substring(0, role.length()))) {
//                    result += j + 1 + ") " +textLines[j].substring(role.length()) + "\n";
//                }
//            }
//            result += "\n";
//        }
